...
$connect = new PDO('mysql:host=localhost;dbname=craftpophouse_db', 'root', '');
...
foreach($result as $row)
{
 $output .= '
 <div class="card">
  <div class="card-header bg-secondary text-white">By <b>'.$row["comment_sender_name"].'</b> on <i>'.$row["date"].'</i></div>
