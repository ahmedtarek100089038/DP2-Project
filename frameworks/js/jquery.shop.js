(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "craftpophouse-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "craftpophousekuching@gmail.com"; // Your Business PayPal's account email address
