...
<html lang="en">
	...
	<!-- Page: product5 (product5.php) -->
	<!-- Author: DP2 -->
	<!-- Date: 25/4/2020 -->
	
	<!-- =========HEAD STARTS HERE========= -->
<head>
    <title>Craft Pop House | Room Decor Page</title>
    <meta charset="utf-8">
    <meta name="author" content="DP2">
    <meta name="description" content="Craft Pop House Page">
    <meta name="keywords" content="Room Decor, craft pop house">
...
<body>
	...
	<div class="container">	
		...
		<h1>Room Decor Category</h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="index.php">Home</a>
			</li>
			<li class="breadcrumb-item">Categories</li>
			<li class="breadcrumb-item active">Room Decor</li>
		</ol>
