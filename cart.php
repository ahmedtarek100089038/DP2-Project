...
if (isset($_POST['update']) && isset($_SESSION['cart'])) {
    ...
    foreach ($_POST as $k => $v) {
        if (strpos($k, 'product_qty') !== false && is_numeric($v)) {
            $id = str_replace('product_qty-', '', $k);
            $quantity = (int)$v;
...
<body>
	...
	<div class="container">	
	<div class="cartt content-wrapperr">
		<h1>Shopping Cart</h1>
                ...
                <tr>
                    <td class="product_image">
                        <a href="product.php?product=<?=$product['product_id']?>" class="product">
							<img src="images/<?=$product['product_image']?>" width="50" height="50" alt="<?=$product['product_title']?>">
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="product_price">RM <?=$product['product_price']?></td>
                    <td class="quantity">
                        <input type="number" name="product_qty-<?=$product['product_id']?>" value="<?=$products_in_cart[$product['product_id']]?>" min="1" max="<?=$product['product_qty']?>" placeholder="Quantity" required>
                    </td>
                    <td class="product_price">RM <?=$product['product_price'] * $products_in_cart[$product['product_id']]?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
